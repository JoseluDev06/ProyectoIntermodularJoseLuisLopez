...
------------------------------------------------------------------------
DESCRIPCION:
  -JUEGO DE PELEA 2D CLÁSICO ESTILO MORTAL KOMBAT
  -GRAFICOS REALES TANTO PERSONAJES COMO FONDOS (PENDIENTE)
  -MUSICA ORIGINAL (PENDIENTE)
...
SIGUIENTES MEJORAS:
  -GRAFICOS REALES
  -INTERACCION ENTRE LOS PERSONAJES
  -MENU DE SELECCION
  -SONIDO

Jose Luis López
1ºDAM
IES el Grao 2025-2026
