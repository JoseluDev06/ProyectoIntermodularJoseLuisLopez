...
public class Player2_temporal: MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player2 = GameObject.Find("Player").transform;
    ...
    {
        if (Input.GetKeyDown(KeyCode.B) && !enAire && !enAtaque && !enBloqueo)
        {
        ...
        if (Input.GetKey(KeyCode.V) && !enAire && !enAtaque)
        {
        ...
        if (Input.GetKeyDown(KeyCode.N) && !enAire && !enAtaque && !enBloqueo)
        {
        ...
        if (Input.GetKeyDown(KeyCode.M) && !enAire && !enAtaque && !enBloqueo)
        {
